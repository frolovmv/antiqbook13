...
// Процедура создание файла на основе данных запроса
...
// Процедура создание файла на основе данных запроса (для ЮВЕЛИРКИ)
...
ShowMessage('  ОПЕРАЦИЯ ПОДГОТОВКИ ПРОШЛА УСПЕШНО!!! ');
